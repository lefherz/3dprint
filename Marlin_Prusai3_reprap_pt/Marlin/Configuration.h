...
#define BED_MAXTEMP 300 // 20 seems to be 170
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 5000 , 812.6}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {250, 250, 3.3, 25}    // (mm/sec)
// was 3000, 3000, 100, 10000
...
#define SDSUPPORT false // Enable SD Card Support in Hardware Console
